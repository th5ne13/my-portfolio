...
<%} %>
            <div class="right_right">
 			...
 			<div id="loginForm">
				...
				<div class="line"></div>
				<a id="a1" href="joinClause.jsp">회원가입</a>
				<a id="a2" href="#">아이디 찾기</a>
				<a id="a3" href="pwdFind.jsp">비밀번호찾기</a>	
...
<div id="body">
	...
	<div class="idFind">
		<div class="container">
			<div class="l_btn" id="findid" onclick="idClick();">아이디 찾기</div>
			<div class="r_btn" id="findpwd" onclick="pwdClick();">비밀번호 찾기</div>
		</div>	
