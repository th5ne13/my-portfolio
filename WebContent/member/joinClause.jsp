...
function chkAgree(frm) {
	var isAgree = frm.isAgree;
	if (!isAgree.checked) {
		alert("필수약관에 동의하셔야 회원가입이 가능합니다.");
		return false;
	}
	return true;
}
function choiceAll(all) {
	var isAgree = document.frmCheck.isAgree;
	var isAgree2 = document.frmCheck.isAgree2;
	
	isAgree.checked = all.checked;
	isAgree2.checked = all.checked;
}
</script>
</head>
<body>
...
⑥ 회사는 회원의 게시물이 제3자로부터 저작권 등의 문제로 이의제기가 있고 그것이 상당한 이유가 있거나 제20조 제2항에서 금지하는 내용에 해당한다고 판단되는 경우, 사전 통지 없이 이를 삭제하거나 등록 자체를 거부할 수 있으며, 저작권 및 권리침해로 인한 게시물의 게시중단 등에 대한 사항은 저작권법 및 관계법령에 따릅니다.				
			...
			<form name="frmCheck" action="joinForm.jsp" method="post" onsubmit="return chkAgree(this);">
...
⑥ 회사는 회원의 게시물이 제3자로부터 저작권 등의 문제로 이의제기가 있고 그것이 상당한 이유가 있거나 제20조 제2항에서 금지하는 내용에 해당한다고 판단되는 경우, 사전 통지 없이 이를 삭제하거나 등록 자체를 거부할 수 있으며, 저작권 및 권리침해로 인한 게시물의 게시중단 등에 대한 사항은 저작권법 및 관계법령에 따릅니다.				
			...
			<div class="isAgree2" id="btn">
				<input type="checkbox" name="isAgree2" value="y" id="isAgree2" /><label for="isAgree2">약관에 동의하시겠습니까? (선택)</label><br /><br />
				<input type="checkbox" name="allCheck" value="y" id="allCheck" onclick="choiceAll(this);" /><label for="allCheck">모두 동의합니다</label><br /><br /><br />			</div>		
			<div id="btn2"><input type="button" value="취 소" onclick="history.back();"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" value="확 인" /></div>
			</form>																		
        </div>
